# Pravia Incidents Platform Infrastructure

Environment-specific infrastructure for the Pravia Incidents platform using Azure Developer CLI (azd) and Bicep templates.

> **Note**: This is a separate deployment from the Mule platform. Each platform has independent Azure resources and configurations.
...
- **Incidents API**: Core incidents management services
- **Notifications API**: Alert and notification services  
- **Reporting API**: Analytics and reporting services
...
- **Incidents App Service**: Alternative containerized deployment
...
**Examples:**
- `rg-pravia-incidents-dev-eastus` (Resource Group)
- `ca-pravia-incidents-api-dev` (Container App)
- `app-pravia-incidents-api-dev` (App Service)
- `acrpraviaincidentsdevxyz123` (Container Registry)
...
**App Services:**
- Incidents API: `https://app-pravia-incidents-api-dev.azurewebsites.net`

**Static Web App:**
- Frontend: `https://swa-pravia-incidents-dev.azurestaticapps.net`

**Swagger Documentation:**
- Container App: `https://ca-pravia-incidents-api-dev.{region}.azurecontainerapps.io/api`
- App Service: `https://app-pravia-incidents-api-dev.azurewebsites.net/api`
...
docker build --platform linux/amd64 -t {registry}.azurecr.io/pravia-incidents-api:latest ./incidents-api
az acr login --name {registry}
docker push {registry}.azurecr.io/pravia-incidents-api:latest

# View Container App logs
az containerapp logs show \
  --name ca-pravia-incidents-api-dev \
  --resource-group rg-pravia-incidents-dev-eastus \
  --follow
